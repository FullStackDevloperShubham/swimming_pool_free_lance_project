...
const Carousel = () => {
  ...
  return (
    <>
      <div className="carousel-container inset-0 w-screen h-full">
          ...
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex space-x-2">
            {item.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 md:w-4 md:h-4 rounded-full ${currentIndex === index ? "bg-white scale-110" : "bg-gray-400"
